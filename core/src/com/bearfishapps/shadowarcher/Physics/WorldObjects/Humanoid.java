...
public class Humanoid extends CustomPhysicsBody{
    ...
    protected float bodyPos[] = {-0.1f, -0f, 0.1f, -0f, 0.1f, 0.6f, -0.1f, 0.6f},
                    ...
                    lArmPos[] = {-0.075f, 0.6f, 0.075f, 0.6f, 0.045f, -0.075f, -0.045f, -0.075f},
    ...
    public Humanoid(World world, Vector2 pos, float scale) {
        ...
        bodies[2] = WorldUtils.createPoly(world, BodyDef.BodyType.DynamicBody, lArmPos, pos.x, pos.y, density*0.4f, 0.1f, friction, CollisionMasks.Mask_ARM, CollisionMasks.Mask_DEFAULT);
        bodies[3] = WorldUtils.createPoly(world, BodyDef.BodyType.DynamicBody, rArmPos, pos.x, pos.y, density*0.4f, 0.1f, friction, CollisionMasks.Mask_ARM, CollisionMasks.Mask_DEFAULT);
        ...
        RevoluteJoint armJoint1 = WorldUtils.makeRevJoint(world, bodies[0], bodies[2],
                new Vector2((bodyPos[0]+bodyPos[2])/2, bodyPos[5]), new Vector2((lArmPos[0]+lArmPos[2])/2, lArmPos[1]));
        RevoluteJoint armJoint2 = WorldUtils.makeRevJoint(world, bodies[0], bodies[3],
                new Vector2((bodyPos[0]+bodyPos[2])/2, bodyPos[5]), new Vector2((rArmPos[0]+rArmPos[2])/2, rArmPos[1]));
